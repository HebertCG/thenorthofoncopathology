...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#161226] text-white">
      <div className="container-custom py-14 sm:py-16">
        <div className="grid gap-10 border-b border-white/12 pb-12 md:grid-cols-2 lg:grid-cols-[1.25fr_1fr_.78fr_1.15fr] lg:gap-12">
          <div>
            ...
            <div className="mt-7 flex items-center gap-3">
              <a
                ...
                className="grid h-10 w-10 place-items-center rounded-full border border-white/18 text-white/72 transition hover:border-[#e2c385] hover:bg-[#e2c385] hover:text-[#161226] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
          ...
          <nav aria-label="Servicios en el pie de página">
            <h2 className="text-sm font-bold uppercase tracking-[0.14em] text-[#e3c68b]">Servicios</h2>
          ...
          <nav aria-label="Sedes en el pie de página">
            <h2 className="text-sm font-bold uppercase tracking-[0.14em] text-[#e3c68b]">Sedes</h2>
            <ul className="mt-5 space-y-3">
              {locations.map((location) => (
                <li key={location}>
                  ...
                  >
                    <MapPin className="h-3.5 w-3.5 text-[#e3c68b]" aria-hidden="true" />
                    {location}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h2 className="text-sm font-bold uppercase tracking-[0.14em] text-[#e3c68b]">Contacto</h2>
            <ul className="mt-5 space-y-4">
              <li>
                ...
                >
                  <Phone className="h-4 w-4 text-[#e3c68b]" aria-hidden="true" />
                  +51 938 683 949
                </a>
              </li>
              <li>
                ...
                >
                  <Mail className="h-4 w-4 text-[#e3c68b]" aria-hidden="true" />
              ...
              <li className="grid grid-cols-[20px_1fr] gap-3 text-sm leading-6 text-white/62">
                <Clock className="mt-0.5 h-4 w-4 text-[#e3c68b]" aria-hidden="true" />
