        ...
        <AnimatedSection className="mt-10 sm:mt-12">
          ...
          >
            ...
            <div className="relative isolate flex min-h-[610px] flex-col">
              <motion.div
                aria-hidden="true"
                className="absolute left-1/2 top-1/3 -z-10 h-[26rem] w-[26rem] -translate-x-1/2 rounded-full bg-[#5cb9bc]/20 blur-3xl"
                  ...
                  >
                    <defs>
                      <linearGradient id="peru-fill" x1="0" y1="0" x2="0.9" y2="1">
                        <stop offset="0%" stopColor="#16929d" />
                        <stop offset="50%" stopColor="#0e646f" />
                        <stop offset="100%" stopColor="#124f68" />
                      </linearGradient>
                      <pattern id="peru-grain" width="30" height="30" patternUnits="userSpaceOnUse">
                        <circle cx="4" cy="4" r="1.8" fill="#a7e2e3" fillOpacity="0.2" />
                      </pattern>
                    ...
                    <path d={PERU_PATH} fill="#0b535b" opacity="0.16" transform="translate(16 22)" />
                      ...
                      >
                        {active && !reduceMotion && (
                          <>
                            <motion.span
                              aria-hidden="true"
                              className="absolute inset-0 m-auto h-5 w-5 rounded-full border-2 border-[#bdf0ef]"
                              animate={{ scale: [1, 2.6], opacity: [0.85, 0] }}
                              transition={{ duration: 1.9, repeat: Infinity, ease: "easeOut" }}
                            />
                            <motion.span
                              aria-hidden="true"
                              className="absolute inset-0 m-auto h-5 w-5 rounded-full border border-[#8fd6d8]"
                        ...
                        <span
                          className={`relative grid h-5 w-5 place-items-center rounded-full border shadow-[0_8px_20px_rgba(9,49,57,.35)] transition-transform duration-300 ${
                            active
                              ? "scale-110 border-[#eafffe] bg-white text-[#0b535b]"
                              : "border-white/90 bg-[#0e646f] text-white hover:scale-125"
                          }`}
                        >
                        ...
                        {active && (
                          <span className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2">
                            <motion.span
                              ...
                              className="block whitespace-nowrap rounded-full bg-white px-3 py-1.5 text-xs font-bold text-[#0b535b] shadow-[0_8px_22px_rgba(9,49,57,.3)]"
                            >
                              {location.city}
                            </motion.span>
                          </span>
            ...
            {/* ── Ficha de la sede ── */}
            <div className="flex min-h-[610px] flex-col rounded-[22px] bg-[#08383e] p-6 text-white shadow-[0_34px_76px_-46px_rgba(9,49,57,.7)] sm:p-9 lg:p-10">
              <div className="flex items-center justify-between gap-5 border-b border-white/15 pb-5">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#95d9da]">Sede seleccionada</p>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="grid h-10 w-10 place-items-center rounded-full border border-white/25 text-white transition hover:bg-white hover:text-[#08383e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                  >
                ...
                >
                  ...
                  <div className="mt-6 divide-y divide-white/15 border-y border-white/15">
                    <div className="grid grid-cols-[26px_1fr] gap-4 py-4">
                      <MapPin className="mt-0.5 h-5 w-5 text-[#95d9da]" strokeWidth={1.7} aria-hidden="true" />
                      <div>
                    ...
                    >
                      <Phone className="mt-0.5 h-5 w-5 text-[#95d9da]" strokeWidth={1.7} aria-hidden="true" />
                      <div>
                    ...
                    <div className="grid grid-cols-[26px_1fr] gap-4 py-4">
                      <Clock3 className="mt-0.5 h-5 w-5 text-[#95d9da]" strokeWidth={1.7} aria-hidden="true" />
                      <div>
                  ...
                  <div className="mt-6 overflow-hidden rounded-[14px] border border-white/15 bg-[#0b464d]">
                    <iframe
                  ...
                  >
                    <Mail className="h-4 w-4 shrink-0 text-[#95d9da]" aria-hidden="true" />
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-auto inline-flex min-h-12 w-fit items-center gap-2 rounded-full bg-[#d7f1f0] px-6 py-3 font-bold text-[#08383e] transition hover:-translate-y-0.5 hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white active:translate-y-px"
                  >
                    Cómo llegar
                  ...
                  <span key={location.city} className="h-1 overflow-hidden rounded-full bg-white/14">
                    {index === activeLocation && (
                      <motion.span
                        ...
                        className="block h-full origin-left bg-[#91d8d9]"
                        initial={{ scaleX: 0 }}
