...
const pillars = [
  ...
  },
  {
    ...
    icon: Eye,
    iconClass: "bg-[linear-gradient(135deg,hsl(254_80%_9%),hsl(0_92%_40%))]",
  },
];
  ...
  return (
    <section id="proposito" className="section-padding relative overflow-hidden bg-background">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-[hsl(37_93%_56%)]/14 blur-3xl" />
      </div>
