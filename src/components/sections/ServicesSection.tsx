...
const ServicesSection = () => {
  ...
  return (
    <section id="servicios" className="overflow-hidden bg-[#f7f6f1] py-20 dark:bg-background sm:py-24">
              ...
              <div ref={servicesRef} data-testid="services-carousel" className="cursor-grab touch-pan-y overflow-hidden active:cursor-grabbing lg:cursor-default">
                <div className="flex -ml-4 lg:ml-0 lg:grid lg:grid-cols-[repeat(3,minmax(0,1fr))_.94fr] lg:gap-4">
                  ...
                  <div className="min-w-0 shrink-0 grow-0 basis-[86%] pl-4 sm:basis-1/2 lg:block lg:basis-auto lg:pl-0">
                    <aside className="flex h-full min-h-[475px] flex-col overflow-hidden rounded-[18px] bg-[#292244] text-white shadow-[0_24px_56px_-38px_rgba(9,49,57,.8)]">
                      ...
                      <div className="flex flex-1 flex-col p-6">
                        <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#e6ca93]">Red especializada</p>
                        ...
                        <button
                          type="button"
                          onClick={scrollToContact}
                          className="mt-auto inline-flex h-11 w-11 items-center justify-center self-end rounded-full border border-white/35 text-white transition hover:bg-white hover:text-[#292244] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
