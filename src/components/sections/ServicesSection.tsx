                    ...
                    <aside className="flex h-full min-h-[475px] flex-col overflow-hidden rounded-[18px] bg-[#223644] text-white shadow-[0_24px_56px_-38px_rgba(9,49,57,.8)]">
                      ...
                      <div className="flex flex-1 flex-col p-6">
                        ...
                        <button
                          type="button"
                          onClick={scrollToContact}
                          className="mt-auto inline-flex h-11 w-11 items-center justify-center self-end rounded-full border border-white/35 text-white transition hover:bg-white hover:text-[#223644] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
