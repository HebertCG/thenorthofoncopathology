              ...
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                <div className="space-y-5 sm:space-y-8">
                  ...
                  >
                    <Button
                      size="lg"
                      className="bg-white text-[#981f1d] hover:bg-white/90 font-semibold text-sm sm:text-base px-5 sm:px-8 h-11 sm:h-14 shadow-lg"
                      onClick={() => scrollToSection("#contacto")}
                    >
                      Solicitar Consulta
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
              ...
              <div className="lg:w-1/2 pr-4 sm:pr-8">
                <div className="space-y-6 sm:space-y-8 text-white">
                  ...
                  >
                    <Button
                      size="lg"
                      className="bg-white text-[#273f4f] hover:bg-white/90 font-semibold text-sm sm:text-base px-5 sm:px-8 h-11 sm:h-14 shadow-lg"
                      onClick={() => scrollToSection("#contacto")}
                    >
                      Solicitar Consulta
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
