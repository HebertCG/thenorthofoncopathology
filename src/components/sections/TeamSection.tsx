                ...
                return (
                  <div key={member.name} className="min-w-0 flex-[0_0_82%] px-2 sm:flex-[0_0_48%]">
                    <motion.article
                      ...
                      className={`relative h-full overflow-hidden rounded-[20px] border bg-[#dcebed] shadow-[0_24px_60px_-34px_rgba(9,49,57,.58)] transition-colors ${active ? "border-primary/35" : "border-white/70"}`}
                    >
                      <div className="relative aspect-[3/4] overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-x-0 bottom-0 h-2/5 bg-gradient-to-t from-[#082f35] via-[#082f35]/78 to-transparent" />
                        <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-6">
                          <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl">{member.name}</h3>
                          <p className="mt-1 text-sm leading-5 text-[#b9e5e5]">{member.role}</p>
                        </div>
                      </div>
                      {member.link && (
                        <a
              ...
              <AnimatePresence mode="wait" initial={false}>
                ...
                >
                  <div className="relative isolate overflow-hidden bg-[#d7e8ea] [perspective:1400px]">
                    ...
                    />
                    <div className="pointer-events-none absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-[#b9d3d6] to-transparent" />
                  </div>
